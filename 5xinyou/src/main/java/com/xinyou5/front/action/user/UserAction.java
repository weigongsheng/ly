...
import com.xingyou5.model.base.SmsSendBean;
import com.xingyou5.model.base.exception.BaseException;
import com.xingyou5.model.base.util.CheckRegex;
import com.xingyou5.model.base.util.CookieUtils;
import com.xingyou5.model.base.util.EncodeUtils;
...
import com.xingyou5.model.user.service.UroleService;
...
public class UserAction extends BaseAction {
	...
	public String updateUserInfo() throws Exception {
		try {
			...
			CustomUserDetails customUserDetail = securityUserService.getCurrentUser();
	...
	public String checkPwdVaild() {
		try {
			if (StringUtils.isNotEmpty(password)) {
				CustomUserDetails user = securityUserService.getCurrentUser();
	...
	public String verifyPhone() {
		...
		try {
			CustomUserDetails cuser = securityUserService.getCurrentUser();
