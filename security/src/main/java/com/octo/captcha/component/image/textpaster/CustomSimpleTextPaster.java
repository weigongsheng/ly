 ...
 * @version 1.0
 */
public class CustomSimpleTextPaster extends AbstractTextPaster {

    public CustomSimpleTextPaster(Integer minAcceptedWordLength, Integer maxAcceptedWordLength,
                            Color textColor) {
    ...
    public BufferedImage pasteText(final BufferedImage background,
        ...
        newAttrString.moveTo(x, (newAttrString.getHeight(0)));
